...
The following table shows the averages for each of the features under consideration. From it, is easy to see that Manhattan leads way on higher average rent prices, shorter commute times and largest number of venues per neighborhood, followed by Brooklyn, Queens and the Bronx.
